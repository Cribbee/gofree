...
import com.cribbee.gofree.util.HttpUtil;
...
/**
 * ClassName: SparkSubmitServiceImpl
 * Description: TODO
 * Author: Cribbee
 * Date: 2020/3/1、5:26 PM
 * Version: 1.0
 **/
...
public class SparkSubmitServiceImpl implements SparkSubmitService{
    ...
    @Override
    public String submitApplication(SparkTest sparkAppParams, String... otherParams) throws IOException, InterruptedException {
